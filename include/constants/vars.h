...
#define VAR_ROUTE101_PLAYER_RESCUE                       0x40A8 // Position var for route 101 rescue by Norman
...
#define VAR_PLAYER_IS_MAY                                0x40B8 // TRUE or FALSE (1 or 0)
#define VAR_MT_PYRE_STATE                                0x40B9
#define VAR_NEW_MAUVILLE_STATE                           0x40BA
#define VAR_PLAYER_IS_BRENDAN                            0x40BB // TRUE or FALSE (1 or 0)
...
#define VAR_RIVAL_WALLY_MON                                0x40DC // Unused
...
#define VAR_ADVENTURE_BEGINS                             0x40F9 // Track custom adventure changes
#define VAR_RIVAL_COUNTER_MB                             0x40FA // Var to count MB Rival battles
#define VAR_RIVAL_COUNTER_WALLY                          0x40FB // Var to count Wally Rival battles
#define VAR_STARTER_REGION                               0x40FC // Multi-starter variable
#define VAR_RIVAL_MB_MON1                                0x40FD // Var to store custom starter rival Mon [Initial Evo]
#define VAR_RIVAL_MB_MON2                                0x40FE // Var to store custom starter rival Mon [Second Evo]
#define VAR_RIVAL_MB_MON3                                0x40FF // Var to store custom starter rival Mon [Third Evo]
